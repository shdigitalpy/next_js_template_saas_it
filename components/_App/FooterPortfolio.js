    ...
    return (
        <>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-footer-widget">
                                <h3>Twitter</h3>
                                <p className="twitter-text">Lorem ipsum dolor sittem amet ngcing elit sed eiusmoad <a href="#">www.oryx.com</a> </p>
            ...
            <div className="copy-right personal-copy-right">
                <div className="container">
                    <p>Copyright &copy; {currentYear} Oryx. Designed by <a href="https://envytheme.com/" target="_blank">EnvyTheme</a></p>
                </div>
            </div>
        </>
    );
