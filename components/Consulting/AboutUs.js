				...
				<div className="row align-items-center">
					<div className="col-lg-6">
						<div className="consulting-about-content">
							...
							<h3>Oryx leading global consulting firm with more than 120+ people working in more than 15 countries. Our consutling farm helps our client in such a way that the client can reach his goal</h3>
